...
public class AppConfigSeedRunner implements ApplicationRunner {
    ...
    private static final Map<String, String> DEFAULT_LINKS = Map.of(
            "bugReportUrl",
            "https://docs.google.com/forms/d/e/1FAIpQLSeh_KMbPhzDiaitBZak6h4iCGK7SR7GIfe6a9HbvEioS7I9WQ/viewform?usp=publish-editor",
            "featureRequestUrl",
            "https://docs.google.com/forms/d/e/1FAIpQLSehV9MdNr462VEWWTJcGBuT0qIWGqDvxg_lg6kE5F3ZEfxFIQ/viewform?usp=publish-editor",
            "reportPostUrl",
            "https://docs.google.com/forms/d/e/1FAIpQLSfb97lsWkWQA-55A4yI5-vJIgz69gP9gDbcCdzhzZFF3LzH-Q/viewform?usp=publish-editor"
    );
    ...
    public void run(ApplicationArguments args) {
        for (Map.Entry<String, String> entry : DEFAULT_LINKS.entrySet()) {
            ...
            if (!appConfigRepository.existsByKey(key)) {
                AppConfigItem item = new AppConfigItem();
